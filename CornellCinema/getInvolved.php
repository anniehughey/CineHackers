		...
		<div class="row content"> -->
			...
			<div class="row content">
				...
				<div class="col-sm-12 col-lg-6">
					...
					<p class="text">Not a Cornell student, or you don't have Work-Study, or you just love to volunteer and want to be involved in the Cinema? Be a Volunteer Usher! Ushers work one night a week (for two films). They arrive early, help set up, rip tickets, watch the film, and help clean up at the end of the night – and, beside a free uniform (a snazzy Cinema Staff T-Shirt), the use of our industrial-strength flashlight and our unending gratitude, Ushers receive a Comp Pass for two to all regular screenings. Please fill out our <a href="http://cinema.cornell.edu/jobs/cinema_application.pdf">Employment Application</a>, noting evenings you are generally available, and drop it by the office..</p>
				</div>
			</div>
			<!-- end of row -->
			<a href="http://cinema.cornell.edu/jobs/cinema_application.pdf" target="_blank">
				<div class="row donate">
					<h1 class="donateButton">APPLY NOW!</h1>
				</div>
			</a>
			<!-- end of apply div-->
			<div class="row content">
